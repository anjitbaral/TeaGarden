...
class TeasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tea" do
    assert_difference('Tea.count') do
      post teas_url, params: { tea: { description: @tea.description, name: @tea.name, origin: @tea.origin, price: @tea.price } }
    end
  ...
  test "should update tea" do
    patch tea_url(@tea), params: { tea: { description: @tea.description, name: @tea.name, origin: @tea.origin, price: @tea.price } }
